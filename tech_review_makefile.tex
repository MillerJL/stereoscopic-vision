...
\vspace{5mm}
\tab {\Medium\textbf{1. User Interface of Mobile App }}\\
...
\vspace{5mm}
\tab {\Medium\textbf{2. User Interface of Desktop App }}\\
...
\vspace{5mm}
\tab {\Medium\textbf{3. Capture Videos }}\\
...
\vspace{5mm}
\tab {\Medium\textbf{4. Stabilization of Videos }} \\
...
\vspace{5mm}
\tab {\Medium\textbf{5. Cropping videos for similar FOV }}\\
...
\tab \tab {\Medium\textbf{f. Best Option:   }}OpenCV\\
\vspace{5mm}
\tab {\Medium\textbf{6. Parsing BLOB}}\\
...
\vspace{5mm}
\tab {\Medium\textbf{7. Correlation of Video Frames }}\\
...
\vspace{5mm}
\tab {\Medium\textbf{8. Viewing 3D video in VR Headset }}\\
...
\\
\tab \tab {\Medium\textbf{e. Discussion:  }}Out of all these options the HTC dev api looks like the easiest option to manipulate \tab \tab \tab the file format into the option that would work best.\\
\tab \tab {\Medium\textbf{f. Best Option:   }}HTC Dev Api\\
\vspace{5mm}
\tab {\Medium\textbf{9. Conversion of 2 Videos into 1 3D Video }}\\
